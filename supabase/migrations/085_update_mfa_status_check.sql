-- Migration: Update MFA Status Check to Handle Admin-Disabled MFA
-- Description: Updates get_users_with_mfa_status function to properly show admin-disabled MFA
-- Date: 2024-01-15

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS get_users_with_mfa_status(INTEGER, INTEGER, TEXT);

-- Create updated function to get users with accurate MFA status
...
-- Test the function
SELECT 'MFA status check function updated successfully' as status;
