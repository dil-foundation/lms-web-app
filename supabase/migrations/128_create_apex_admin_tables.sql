-- Create APEX (AI-Powered Educational eXperience) Admin Tables
-- This migration creates tables for managing AI Assistant content: FAQs, Knowledge Base, and Contact Info
