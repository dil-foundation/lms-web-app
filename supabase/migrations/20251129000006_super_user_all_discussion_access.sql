-- Give super_user unrestricted access to ALL discussions
-- Super users should see all discussions regardless of participant settings

-- Update get_discussion_details function to give super_user full access
...
BEGIN
    ...
    AND (
        -- Super user has access to ALL discussions
...
-- Update get_discussions_for_user function to give super_user full access
...
-- Update get_discussions_for_user_count function to give super_user full access
