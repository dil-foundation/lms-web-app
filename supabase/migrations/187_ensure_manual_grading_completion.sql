-- Ensure manual grading completion works correctly
-- This migration adds debugging and ensures the function works properly
...
BEGIN
  ...
  IF update_count = 0 THEN
    RAISE EXCEPTION 'Failed to update attempt % - no rows were updated', input_attempt_id;
  END IF;
...
-- Test the function with a sample call (commented out)
