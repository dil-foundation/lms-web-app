-- Fix admin/super_user discussion access to respect participant list
-- Admins should only see discussions they're participants of, not ALL discussions
-- Also fix get_discussion_details to check permissions

-- Update get_discussion_details function to check permissions
...
-- Update get_discussions_for_user function
