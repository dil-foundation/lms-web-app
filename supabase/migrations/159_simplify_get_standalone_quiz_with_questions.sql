-- Migration: Simplify get_standalone_quiz_with_questions function
-- Remove members column to avoid schema cache issues, fetch members separately in service

-- Drop and recreate the function without the members column
