...
-- This should resolve the 42702 error about ambiguous "id" column reference
...
COMMENT ON FUNCTION public.get_standalone_quiz_with_questions(uuid) IS 'Gets a quiz with its questions and options - fixed ambiguous column reference';
