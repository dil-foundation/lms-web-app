-- Migration: Revert to Original Admin Function
-- Description: Revert to the original working get_admin_assessments_data function
-- Date: 2025-01-15

-- Drop the enhanced function that has type issues
