-- Fix get_standalone_quiz_with_questions function to handle edge cases
-- This should resolve issues with quiz loading
...
COMMENT ON FUNCTION public.get_standalone_quiz_with_questions(uuid) IS 'Gets a quiz with its questions and options - fixed to handle edge cases';
