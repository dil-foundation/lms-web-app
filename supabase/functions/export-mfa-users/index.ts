...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🔍 export-mfa-users function: Search term:', searchTerm);
    ...
    if (usersError) {
      console.error('❌ export-mfa-users function: Query error:', usersError);
    ...
    console.log(`✅ export-mfa-users function: Returning ${exportData.length} users`);
    ...
    console.error('❌ export-mfa-users function: Error:', error);
