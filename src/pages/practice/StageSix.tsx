...
const practiceActivities = [
  {
    ...
    description: 'Master natural, spontaneous communication',
    icon: MessageSquare,
    bgColor: 'bg-gradient-to-br from-primary to-primary/90',
  },
  {
    id: 'sensitive-scenario',
    title: 'Sensitive Scenario Roleplay',
    description: 'Handle delicate situations professionally',
    icon: Zap,
  ...
  },
  {
    ...
    description: 'Develop and express sophisticated viewpoints',
    icon: Users,
    bgColor: 'bg-gradient-to-br from-primary to-primary/90',
  },
];
      ...
      <div className="relative">
        ...
        <div className="relative p-6 sm:p-8 md:p-10 rounded-3xl">
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-primary via-primary/90 to-primary bg-clip-text text-transparent">Stage 6 - C2 Proficiency</h1>
              <p className="text-xs sm:text-sm text-muted-foreground">C2 Proficiency Level</p>
            </div>
          </div>
          ...
          <div className="mt-5 text-center">
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Achieve native-like fluency and mastery of complex language structures
            </p>
          </div>
        </div>
      </div>
