      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="px-4 sm:px-6 pb-8 space-y-6">
          ...
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r from-primary via-primary/90 to-primary bg-clip-text text-transparent">Listen & Speak Your Summary</h2>
              ...
              <div className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-6">
                    ...
                    <Button
                      onClick={() => navigate('/dashboard/practice/stage-4/news-summary')}
