...
export default function QuickAnswer() {
  ...
  const markExerciseCompleted = async () => {
    if (user?.id) {
      try {
        ...
        console.log('Exercise marked as completed: Stage 2, Exercise 2 (QuickAnswer)');
      } catch (error) {
  ...
  const handleNext = () => {
    if (currentQuestionIndex === questions.length - 1) {
      // User is on the last question, mark as completed
      setIsCompleted(true);
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Button
                    ...
                    className="text-xs px-3 py-1 h-7 bg-gradient-to-br from-card to-card/50 dark:bg-card backdrop-blur-sm border-gray-200/60 dark:border-gray-700/60 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
                  >
          ...
          <div className="p-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Great job on your quick answer practice. You can redo the exercise to practice more or continue to other exercises.
              </p>
