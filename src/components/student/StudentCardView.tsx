              ...
              <div className="flex flex-col gap-3 sm:gap-4">
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2 sm:gap-3 md:gap-4 flex-1 min-w-0">
                    <Avatar className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 flex-shrink-0 ring-2 ring-primary/20 group-hover:ring-primary/40 transition-all duration-300">
                      <AvatarImage src={student.avatar_url} />
                      <AvatarFallback className="bg-gradient-to-br from-primary/20 via-primary/30 to-primary/40 text-primary text-sm sm:text-base md:text-lg font-semibold">
                        {student.firstName?.[0]}{student.lastName?.[0]}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-sm sm:text-base md:text-lg line-clamp-2 group-hover:text-primary transition-colors mb-0.5 sm:mb-1 leading-tight">
              ...
              <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-border/50">
                <div className="flex gap-1.5 sm:gap-2 md:gap-3">
                  <Button
                    size="sm"
                    variant="outline"
                    className="flex-1 h-8 sm:h-9 md:h-10 text-[10px] sm:text-xs md:text-sm hover:bg-primary/10 hover:text-primary hover:border-primary/30 transition-all duration-200 font-medium px-2 sm:px-3 min-w-0"
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="flex-1 h-8 sm:h-9 md:h-10 text-[10px] sm:text-xs md:text-sm hover:bg-blue-500/10 hover:text-blue-500 hover:border-blue-500/30 transition-all duration-200 font-medium px-2 sm:px-3 min-w-0"
